...
class JenisPembayaranController extends Controller
{
        ...
        if (property_exists($result, 'data')){
            ...
            foreach ($result as $resp){
                $btnEdit = view('components.Button', [
                    'method' => 'GET',
                    'action' => route('bendahara.jenispembayaran.edit', $resp->id),
                    'title' => 'Edit',
                ...
                $btnDelete = view('components.Button', [
                    'method' => 'GET',
                    'action' => route('bendahara.jenispembayaran.destroy', $resp->id),
                    'title' => 'Hapus',
    ...
    public function store(Request $request){
        ...
        if ($jenispembayaran->message_id == '00'){
            return redirect(route('bendahara.jenispembayaran.index'))->with('alert', $jenispembayaran->status);
        }
        else {
            return redirect(route('bendahara.jenispembayaran.index'))->with('alert-failed', $jenispembayaran->status);
        }
    }
    ...
    public function destroy($id){
        ...
        return redirect(route('bendahara.jenispembayaran.index'))->with('alert',  'Data terhapus');
    }
}
