...
<x-app-layout title="Edit Siswa {{ $siswa->nama_siswa }}">
	<x-form method="GET" action="{{ route('admin.siswa.update', $siswa->id) }}">
		<x-adminlte-card theme="lime" theme-mode="outline" title="Isi Data Siswa">
			<div class="row">
				<x-adminlte-input name="nama_siswa" label="Nama Siswa" placeholder="Alfalah" fgroup-class="col-md-4" value="{{ $siswa->nama_siswa }}" required />
				<x-adminlte-input name="nomor_kip" label="No KIP" placeholder="1234567890123456" fgroup-class="col-md-4" type="number" value="{{ $siswa->nomor_kip }}" required />
				<x-adminlte-input name="nis" label="NIS" placeholder="1277471818" fgroup-class="col-md-4" type="number" value="{{ $siswa->nis }}" required />
			</div>
			<div class="row">
				<x-adminlte-input name="nisn" label="NISN" placeholder="1277471818" fgroup-class="col-md-3" type="number" value="{{ $siswa->nisn }}" required />
				<x-adminlte-input name="nik" label="NIK" placeholder="1234567890123456" fgroup-class="col-md-3" type="number" value="{{ $siswa->nik }}" required />
			...
			<div class="row">
				...
				<x-adminlte-input name="tempat_lahir" label="Tempat Lahir" placeholder="Semarang" fgroup-class="col-md-3" value="{{ $siswa->tempat_lahir }}" required />
				<x-adminlte-input-date name="tanggal_lahir" :config="$config_date" label="Tanggal Lahir" placeholder="Choose a time..." fgroup-class="col-md-3" value="{{ $siswa->tanggal_lahir }}" required>
					<x-slot name="prependSlot">
						<div class="input-group-text bg-gradient-info">
			...
			<div class="row">
				<x-adminlte-input name="nomor_kk" label="No KK" placeholder="1234567890123456" fgroup-class="col-md-4" type="number" value="{{ $siswa->nomor_kk }}" required />
			...
			<div class="row">
				<div class="col-md-6">
					<x-adminlte-card theme="lightblue" theme-mode="outline" title="Isi Data Ayah">
						<div class="row">
							<x-adminlte-input name="nama_ayah" label="Nama Wali" placeholder="Alfa" fgroup-class="col-md-6" value="{{ $walisiswa->nama_ayah }}" />
							<x-adminlte-input-file name="file_kk_ayah" igroup-size="md" placeholder="Pilih file..." label="File KK Ayah" value="{{ $walisiswa->file_kk_ayah }}" fgroup-class="col-md-6">
								<x-slot name="prependSlot">
									<!-- <div class="input-group-text bg-lightblue">
									<i class="fas fa-address-card"></i>
								</div> -->
						...
						<div class="row">
							...
							<x-adminlte-input name="nik_ayah" label="NIK" value="{{$walisiswa->nik_ayah}}" placeholder="1234567890123456" fgroup-class="col-md-6" type="number" value="{{ $walisiswa->nik_ayah }}" required />
						...
						<div class="row">
							<x-adminlte-input name="tempat_lahir_ayah" label="Tempat Lahir" placeholder="Semarang" fgroup-class="col-md-6" value="{{ $walisiswa->tempat_lahir_ayah }}" required />
						...
						<div class="row">
							...
							<x-adminlte-input name="pekerjaan_ayah" label="Pekerjaan" placeholder="PNS" fgroup-class="col-md-6" value="{{ $walisiswa->pekerjaan_ayah }}" required />
						</div>
						<div class="row">
							<x-adminlte-input name="penghasilan_ayah" label="Penghasilan Perbulan" placeholder="124155151" type="number" fgroup-class="col-md-6" value="{{ $walisiswa->penghasilan_ayah }}" required />
				...
				<div class="col-md-6">
					<x-adminlte-card theme="lightblue" theme-mode="outline" title="Isi Data Ibu">
						<div class="row">
							<x-adminlte-input name="nama_ibu" label="Nama Wali" placeholder="Alfa" fgroup-class="col-md-6" value="{{ $walisiswa->nama_ibu }}" required />
						...
						<div class="row">
							<x-adminlte-input name="nik_ibu" value="{{$walisiswa->nik_ibu}}" label="NIK" placeholder="1234567890123456" fgroup-class="col-md-6" type="number" value="{{ $walisiswa->nik_ibu }}" required />
						...
						<div class="row">
							<x-adminlte-input name="tempat_lahir_ibu" label="Tempat Lahir" placeholder="Semarang" fgroup-class="col-md-6" value="{{ $walisiswa->tempat_lahir_ibu }}" required />
							...
							<x-adminlte-input name="pekerjaan_ibu" label="Pekerjaan" placeholder="PNS" fgroup-class="col-md-6" value="{{ $walisiswa->pekerjaan_ibu }}" required />
						</div>
						<div class="row">
							...
							<x-adminlte-input name="penghasilan_ibu" label="Penghasilan Perbulan" placeholder="124155151" type="number" fgroup-class="col-md-6" value="{{ $walisiswa->penghasilan_ibu }}" required />
                ...
                <div class="col-md-6">
                    <x-adminlte-card theme="lightblue" theme-mode="outline" title="Isi Data Wali">
                        <div class="row">
                            ...
                            <x-adminlte-input name="nama_wali" label="Nama Wali" placeholder="Alfa" fgroup-class="col-md-6" value="{{ $walisiswa->nama_wali }}" />
                        </div>
                        <div class="row">
                            <x-adminlte-textarea name="keterangan" fgroup-class="col-md-6" label="Keterangan" placeholder="Keterangan">{{ $walisiswa->keterangan }}</x-adminlte-textarea>
                            <x-adminlte-textarea name="alamat_wali" fgroup-class="col-md-6" label="Alamat" placeholder="Masukkan alamat">
                                {{ $walisiswa->alamat_wali }}
                            </x-adminlte-textarea>
                        </div>
{{--                        <div class="row">--}}
{{--                            <x-adminlte-input name="tempat_lahir_wali" label="Tempat Lahir" placeholder="Semarang" fgroup-class="col-md-6" value="{{ $walisiswa->tempat_lahir_wali }}" />--}}
{{--                            <x-adminlte-input-date name="tanggal_lahir_wali" :config="$config_date" label="Tanggal Lahir" placeholder="Choose a time..." fgroup-class="col-md-6" value="{{ $walisiswa->tanggal_lahir_wali }}">--}}
{{--                                <x-slot name="prependSlot">--}}
{{--                                    <div class="input-group-text bg-gradient-info">--}}
{{--                                        <i class="fas fa-clock"></i>--}}
{{--                                    </div>--}}
...
{{--                                <option {{old('pendidikan',$walisiswa->pendidikan_ibu)=="Tidak Bersekolah"? 'selected':''}} value="Tidak Bersekolah">Tidak Bersekolah</option>--}}
{{--                            </x-adminlte-select2>--}}
{{--                            <x-adminlte-input name="pekerjaan_wali" label="Pekerjaan" placeholder="PNS" fgroup-class="col-md-6" value="{{ $walisiswa->pekerjaan_wali }}" />--}}
{{--                        </div>--}}
{{--                        <div class="row">--}}
...
{{--                        </div>--}}
                ...
                <x-adminlte-card theme="lightblue" theme-mode="outline" title="No KKS/PKH">
                    <div class="row">
                        <x-adminlte-input name="nomor_kks" value="0" label="Nomor KKS" placeholder="124155151" type="number" fgroup-class="col-md-4" value="{{ $siswa->nomor_kks }}" />
                        <x-adminlte-input name="nomor_pkh" value="0" label="Nomor PKH" placeholder="124155151" type="number" fgroup-class="col-md-4" value="{{ $siswa->nomor_pkh }}" />
                    </div>
                </x-adminlte-card>
