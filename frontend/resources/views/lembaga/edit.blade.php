            ...
            <x-adminlte-card theme="info" theme-mode="info" title="Edit Data Lembaga">
                ...
                <div class="row">
                    <x-adminlte-input-date name="tahun_berdiri" :config="$config_date" label="Tanggal Berdiri" placeholder="Choose a time..."
                                           value="{{ $lembaga->tahun_berdiri }}" fgroup-class="col-md-6" required>
                    ...
                    <x-adminlte-input name="no_telp" label="Nomor Telp" placeholder="40"
                                      fgroup-class="col-md-6" value="{{ $lembaga->no_telp }}" type="number" required/>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <x-adminlte-input name="npsn" label="Nomor NPSN" placeholder="40"
                                      fgroup-class="col-md-6" type="number" value="{{ $lembaga->npsn }}" required/>
                    <x-adminlte-input name="nsm" label="Nomor NSM" placeholder="40"
                                      fgroup-class="col-md-6" type="number" value="{{ $lembaga->nsm }}" required/>
                </div>
                <div class="row">
                    <x-adminlte-input name="nomor_surat_operasional" label="Nomor SK Operasional" placeholder="F/240/JK/2022"
                                      fgroup-class="col-md-6" value="{{ $sklembaga->nomor_surat_operasional }}" type="text"/>
