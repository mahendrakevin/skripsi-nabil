...
class WaliSiswa(Base):
    ...
    status_keluarga_ayah = Column(String(20))
    status_hidup_ayah = Column(String(20))
    no_hp_ayah = Column(BigInteger)
    ...
    status_keluarga_ibu = Column(String(20))
    status_hidup_ibu = Column(String(20))
    no_hp_ibu = Column(BigInteger)
